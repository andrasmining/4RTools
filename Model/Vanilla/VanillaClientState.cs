...
namespace _4RTools.Model.Vanilla
{
    public enum VanillaField
    {
        ...
        CurrentTargetId, ActionState, Map, AutobattleEnabled, StatusEffects
    }
            ...
            VanillaMemoryMap map, string unavailableError = null)
        {
            ...
            foreach (VanillaField field in Enum.GetValues(typeof(VanillaField)))
            {
                ...
                switch (field)
                {
                    ...
                    case VanillaField.AutobattleEnabled:
            ...
            {
                SessionId = session, SampledAtUtc = now, Error = unavailableError,
